...
# Scrapes offensive player sata for a single NFL season
def single(season):
    url = f'https://www.pro-football-reference.com/years/{season}/scrimmage.htm'
...
# Save to CSV
output_file = 'NFL Offense Player Stats(2004 - 2024).csv'
